...
- **Stage transition tracking:** Captures when a Deal enters and exits each stage, creating a historical view of how the opportunity moves through the sales process.
    
- **Stage duration logic:** Calculates how long a Deal spends in each stage, making it easier to identify bottlenecks, stalled opportunities, and process friction.
    
- **Deal velocity metrics:** Updates the Deal record with key sales cycle measurements, including time in current stage, total cycle time, and stalled status indicators.
    
- **Reporting-ready stage history:** Stores stage movement in a structured format so leadership can analyze pipeline movement instead of relying only on current-stage snapshots.
    
- **Automation governance:** Separates orchestration, stage transition logic, and velocity calculation into focused automation components, making the process easier to maintain, troubleshoot, and expand.
