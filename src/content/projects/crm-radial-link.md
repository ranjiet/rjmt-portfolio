...
title: CRM Radial Link Automation
...
permalink: /projects/crm-radial-link/
featured: false
---

### Problem

The problem is not simply assigning an Account or Contact to the right person. The problem is making sure the CRM understands the geography behind the customer.
